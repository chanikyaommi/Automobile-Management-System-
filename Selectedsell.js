...
function SelectedSell() {
    ...
    // Define the handleSellButtonClick function
    const handleSellButtonClick = () => {
        // Use navigate to go to the /selectedsell route
        navigate('/selectedsell');
    };
